    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white font-sans">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-200/50 text-gray-900 py-4 px-6 shadow-sm">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-3 space-x-reverse">
            ...
            {/* <img src="/union-logo.png" alt="لوگوی اتحادیه" className="w-8 h-8 ml-2" /> */}
            <div className="text-2xl font-bold bg-gradient-to-r from-yellow-600 to-amber-600 bg-clip-text text-transparent">{t('brand')}</div>
          </div>
          <div className="hidden md:flex space-x-8 space-x-reverse">
            <a href="#features" className="hover:text-yellow-600 transition-all duration-300 font-medium text-gray-700 hover:scale-105">{t('nav.features')}</a>
            <a href="#how-it-works" className="hover:text-yellow-600 transition-all duration-300 font-medium text-gray-700 hover:scale-105">{t('nav.howItWorks')}</a>
            <a href="#stats" className="hover:text-yellow-600 transition-all duration-300 font-medium text-gray-700 hover:scale-105">{t('nav.stats')}</a>
            <a href="#contact" className="hover:text-yellow-600 transition-all duration-300 font-medium text-gray-700 hover:scale-105">{t('nav.contact')}</a>
          </div>
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-gray-900 to-black text-white py-32 px-6 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black mb-8 leading-tight bg-gradient-to-r from-white via-gray-100 to-white bg-clip-text text-transparent">
            {t('hero.title1')}<br />
            <span className="bg-gradient-to-r from-yellow-400 via-amber-400 to-yellow-500 bg-clip-text text-transparent">{t('hero.title2')}</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-yellow-200 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-900">{t('features.1.title')}</h3>
              <p className="text-gray-600 leading-relaxed">{t('features.1.desc')}</p>
            </div>
            ...
            <div className="group bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-yellow-200 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-900">{t('features.2.title')}</h3>
              <p className="text-gray-600 leading-relaxed">{t('features.2.desc')}</p>
            </div>
            ...
            <div className="group bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-yellow-200 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-900">{t('features.3.title')}</h3>
              <p className="text-gray-600 leading-relaxed">{t('features.3.desc')}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900">{t('howItWorks.1.title')}</h3>
              <p className="text-gray-600 leading-relaxed text-lg">{t('howItWorks.1.desc')}</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900">{t('howItWorks.2.title')}</h3>
              <p className="text-gray-600 leading-relaxed text-lg">{t('howItWorks.2.desc')}</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900">{t('howItWorks.3.title')}</h3>
              <p className="text-gray-600 leading-relaxed text-lg">{t('howItWorks.3.desc')}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-10 border border-white/10 hover:border-yellow-400/30 transition-all duration-300 hover:scale-105 shadow-2xl">
              <div className="text-6xl md:text-7xl font-black text-transparent bg-gradient-to-r from-yellow-400 to-amber-400 bg-clip-text mb-6">{t('stats.1.value')}</div>
              <div className="text-2xl font-bold mb-3 text-white">{t('stats.1.title')}</div>
              <div className="text-gray-300">{t('stats.1.desc')}</div>
            </div>
            
            <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-10 border border-white/10 hover:border-yellow-400/30 transition-all duration-300 hover:scale-105 shadow-2xl">
              <div className="text-6xl md:text-7xl font-black text-transparent bg-gradient-to-r from-yellow-400 to-amber-400 bg-clip-text mb-6">{t('stats.2.value')}</div>
              <div className="text-2xl font-bold mb-3 text-white">{t('stats.2.title')}</div>
              <div className="text-gray-300">{t('stats.2.desc')}</div>
            </div>
            
            <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-10 border border-white/10 hover:border-yellow-400/30 transition-all duration-300 hover:scale-105 shadow-2xl">
              <div className="text-4xl md:text-5xl font-black text-transparent bg-gradient-to-r from-yellow-400 to-amber-400 bg-clip-text mb-6">{t('stats.3.value')}</div>
              <div className="text-2xl font-bold mb-3 text-white">{t('stats.3.title')}</div>
              <div className="text-gray-300">{t('stats.3.desc')}</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-6">
              <span className="bg-gradient-to-r from-yellow-600 to-amber-600 bg-clip-text text-transparent">{t('partners.title1')}</span> {t('partners.title2')}
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              {t('partners.subtitle')}
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 text-center aspect-square flex items-center justify-center hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-yellow-300 group hover:scale-105">
              <div className="text-lg font-bold text-gray-600 group-hover:text-gray-800 transition-colors">{t('partners.logo1')}</div>
            </div>
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 text-center aspect-square flex items-center justify-center hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-yellow-300 group hover:scale-105">
              <div className="text-lg font-bold text-gray-600 group-hover:text-gray-800 transition-colors">{t('partners.logo2')}</div>
            </div>
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 text-center aspect-square flex items-center justify-center hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-yellow-300 group hover:scale-105">
              <div className="text-lg font-bold text-gray-600 group-hover:text-gray-800 transition-colors">{t('partners.logo3')}</div>
            </div>
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 text-center aspect-square flex items-center justify-center hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-yellow-300 group hover:scale-105">
              <div className="text-lg font-bold text-gray-600 group-hover:text-gray-800 transition-colors">{t('partners.logo4')}</div>
            </div>
          </div>
          <p className="text-center text-gray-600 text-lg">
            {t('partners.bottomText')}
          </p>
        </div>
      </section>
      ...
      <footer id="contact" className="bg-gradient-to-br from-gray-900 to-black text-white py-20 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
          <div>
            <h3 className="text-xl font-bold mb-8 text-yellow-400">{t('footer.linksTitle')}</h3>
          ...
          <div>
            <h3 className="text-xl font-bold mb-8 text-yellow-400">{t('footer.aboutTitle')}</h3>
          ...
          <div>
            <h3 className="text-xl font-bold mb-8 text-yellow-400">{t('footer.contactTitle')}</h3>
          ...
          <div>
            <h3 className="text-xl font-bold mb-8 text-yellow-400">{t('footer.socialTitle')}</h3>
        ...
        <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-gray-700 text-center text-gray-400 flex flex-col items-center justify-center">
          <div className="flex items-center justify-center mb-2">
            <img src="/union-logo.png" alt="لوگوی اتحادیه" className="w-6 h-6 ml-2" />
