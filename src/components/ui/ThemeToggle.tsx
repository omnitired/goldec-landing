...
const ThemeToggle: React.FC<ThemeToggleProps> = ({ className }) => {
  ...
  if (!mounted) {
    return (
      <button
        className={cn(
          "relative inline-flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-blue-400/10 to-blue-500/10 text-blue-400 transition-all duration-300 hover:bg-gradient-to-br hover:from-blue-400/20 hover:to-blue-500/20 hover:text-blue-300 hover:shadow-lg hover:shadow-blue-500/25 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2 focus:ring-offset-transparent",
          className
        )}
